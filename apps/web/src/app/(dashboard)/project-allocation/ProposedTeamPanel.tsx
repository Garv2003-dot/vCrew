        ...
        <div className="mt-0 transition-opacity duration-500 ease-in-out h-full overflow-auto flex flex-col">
          ...
          <div className="mt-6 pt-4 border-t border-gray-200 flex gap-3 justify-end">
            <button
              type="button"
              onClick={onDiscard}
              className="flex items-center gap-2 px-4 py-2 rounded-md border border-red-200 bg-white text-red-700 hover:bg-red-50 transition-colors shadow-sm text-sm font-medium"
